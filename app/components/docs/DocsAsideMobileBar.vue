...
import type { ContentTocLink } from "#ui/components/content/ContentToc.vue";

defineProps<{
  links?: ContentTocLink[];
}>();

const { showCategorySidebar, sidebarNavigation, currentSection } =
  useSubNavigation();
...
<template>
  <!-- 分类文档页：sticky 栏提供栏目菜单 + 本页 TOC 抽屉 -->
  <div
